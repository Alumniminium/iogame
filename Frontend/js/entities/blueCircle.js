...
export class BlueCircle extends Entity {
    ...
    draw(ctx) {
        ...
        // Draw health bar
        ctx.fillStyle = 'white';
        ctx.fillRect(this.originX() - this.size * 1.5, this.originY() - this.radius, this.size * 3, 4);
        ctx.fillStyle = 'red';
        ctx.fillRect(this.originX() - this.size * 1.5, this.originY() - this.radius, (this.size * 3) / 100 * (100 * this.health / this.maxHealth), 4);
        ctx.fillStyle = 'white';
