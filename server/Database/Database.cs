...
namespace iogame.Simulation.Database
{
    public static class Db
    {
        ...
        public static void CreateResources()
        {
            ...
            var squ = new BaseResource(sides: 4, size: 15, color: 0, borderColor: 0, mass: (float)Math.Pow(15, 3), elasticity: 1.0f, drag: 0.01f, health: 100, bodyDamage: 1, maxAliveNum: 400);
