...
namespace iogame.Simulation.Database
{
    public static class Db
    {
        ...
        {
            var tri = new BaseResource(sides: 3, size: 150, color: 0, borderColor: 0, mass: (float)Math.Pow(150, 3), elasticity: 1.0f, drag: 0.9999f, health: 200, bodyDamage: 1, maxAliveNum: 1000);
            var squ = new BaseResource(sides: 4, size: 100, color: 0, borderColor: 0, mass: (float)Math.Pow(100, 3), elasticity: 1.0f, drag: 0.9999f, health: 100, bodyDamage: 1, maxAliveNum: 500);
            var pen = new BaseResource(sides: 5, size: 200, color: 0, borderColor: 0, mass: (float)Math.Pow(200, 3), elasticity: 1.0f, drag: 0.9999f, health: 400, bodyDamage: 1, maxAliveNum: 150);
            var hex = new BaseResource(sides: 6, size: 300, color: 0, borderColor: 0, mass: (float)Math.Pow(300, 3), elasticity: 1.0f, drag: 0.9999f, health: 800, bodyDamage: 1, maxAliveNum: 30);
