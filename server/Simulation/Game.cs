...
namespace server.Simulation
{
    public static class Game
    {
        ...
        static Game()
        {
            ...
            SpawnManager.CreateStructure(500, 5, new Vector2(600, MapSize.Y - 250), 20f, Convert.ToUInt32("80ED99", 16), ShapeType.Box);
            SpawnManager.CreateStructure(500, 5, new Vector2(1200, MapSize.Y - 250), -20f, Convert.ToUInt32("10EFAA", 16),ShapeType.Box);
            SpawnManager.CreateStructure(50, 5, new Vector2(820, MapSize.Y - 200), 80f, Convert.ToUInt32("434343", 16),ShapeType.Box);
            SpawnManager.CreateStructure(50, 5, new Vector2(980, MapSize.Y - 200), 110f, Convert.ToUInt32("30ED99", 16),ShapeType.Box);
            ...
            // var shield = new ShieldComponent(dome.Id, 100, 10000, 0, 125, 125, 10, TimeSpan.FromSeconds(4));
