...
namespace server.Simulation
{
    ...
    public static class Game
    {
        ...
        static Game()
        {
            ...
            SpawnManager.CreateSpawner((int)(MapSize.X / 2), (int)(MapSize.Y - 300), 3, TimeSpan.FromMilliseconds(250), 1, 100);
            // SpawnManager.Respawn();
            SpawnManager.CreateStructure(500,30, new Vector2(500, 850), 20f);
