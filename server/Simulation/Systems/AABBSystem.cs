...
public unsafe sealed class AABBSystem : NttSystem<AABBComponent, PhysicsComponent>
{
    public AABBSystem() : base("AABB System", threads: 1) { }
    protected override bool MatchesFilter(in NTT ntt) => base.MatchesFilter(in ntt);

    public override void Update(in NTT ntt, ref AABBComponent aabb, ref PhysicsComponent phy)
    {
...
public unsafe sealed class AABBSystem : NttSystem<AABBComponent, PhysicsComponent>
{
    ...
    {
        return ntt.Type != EntityType.Pickable && ntt.Type != EntityType.Static && base.MatchesFilter(in ntt);
    }
    public override void Update(in NTT ntt, ref AABBComponent aabb, ref PhysicsComponent phy)
    {
        if (phy.LastPosition == phy.Position && phy.LastRotation == phy.RotationRadians)
