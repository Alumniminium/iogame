...
namespace server.Simulation.Database
{
    public static class Db
    {
        ...
        public static void CreateResources()
        {
            ...
            var pen = new BaseResource(sides: 5, size: 40, color: Convert.ToUInt32("6F2DBD", 16), borderColor: 0, mass: (float)Math.Pow(20, 3), elasticity: 1.0f, drag: 0.01f, health: 400, bodyDamage: 0, maxAliveNum: 1000);
