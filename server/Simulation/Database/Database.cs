...
namespace server.Simulation.Database
{
    public static class Db
    {
        ...
        public static void CreateResources()
        {
            ...
            var squ = new BaseResource(sides: 4, size: 5, color: Convert.ToUInt32("DB5461", 16), borderColor: 0,  mass: MathF.Pow(1, 3), elasticity: 0.5f, drag: 0.01f, health: 1000, bodyDamage: 0, maxAliveNum: 10000);
