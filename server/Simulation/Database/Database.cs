...
namespace server.Simulation.Database
{
    public static class Db
    {
        ...
        {
            var asteroid = new BaseResource(sides: 7, size: 50, color: Convert.ToUInt32("523E3D", 16), borderColor: 0, mass: MathF.Pow(100, 3), elasticity: 0.1f, drag: 0.01f, health: 2000, bodyDamage: 0, maxAliveNum: 1);
            var tri = new BaseResource(sides: 3, size: 15, color: Convert.ToUInt32("80ED99", 16), borderColor: 0, mass: MathF.Pow(5, 3), elasticity: 1.0f, drag: 0.01f, health: 20, bodyDamage: 0, maxAliveNum: 10000);
            var squ = new BaseResource(sides: 4, size: 10, color: Convert.ToUInt32("DB5461", 16), borderColor: 0, mass: MathF.Pow(1, 3), elasticity: 0.5f, drag: 0.01f, health: 10, bodyDamage: 0, maxAliveNum: 20000);
            var pen = new BaseResource(sides: 5, size: 25, color: Convert.ToUInt32("6F2DBD", 16), borderColor: 0, mass: MathF.Pow(10, 3), elasticity: 1.0f, drag: 0.01f, health: 200, bodyDamage: 0, maxAliveNum: 10);
            var hex = new BaseResource(sides: 6, size: 40, color: Convert.ToUInt32("FAA916", 16), borderColor: 0, mass: MathF.Pow(30, 3), elasticity: 1.0f, drag: 0.01f, health: 500, bodyDamage: 0, maxAliveNum: 1);
