...
namespace server.Simulation.Database
{
    public static class Db
    {
        ...
        {
            var tri = new BaseResource(sides: 3, size: 4, color: Convert.ToUInt32("80ED99", 16), borderColor: 0, mass: MathF.Pow(5, 3), elasticity: 1.01f, drag: 0.01f, health: 100, bodyDamage: 0, maxAliveNum: 300);
            var squ = new BaseResource(sides: 4, size: 8, color: Convert.ToUInt32("DB5461", 16), borderColor: 0, mass: MathF.Pow(1, 3), elasticity: 1.0f, drag: 0.01f, health: 200, bodyDamage: 0, maxAliveNum: 500);
            var pen = new BaseResource(sides: 5, size: 12, color: Convert.ToUInt32("6F2DBD", 16), borderColor: 0, mass: MathF.Pow(10, 3), elasticity: 1f, drag: 0.01f, health: 300, bodyDamage: 0, maxAliveNum: 100);
            var hex = new BaseResource(sides: 6, size: 16, color: Convert.ToUInt32("FAA916", 16), borderColor: 0, mass: MathF.Pow(30, 3), elasticity: 11f, drag: 0.01f, health: 500, bodyDamage: 0, maxAliveNum: 10);
            var idk = new BaseResource(sides: 7, size: 20, color: Convert.ToUInt32("523E3D", 16), borderColor: 0, mass: MathF.Pow(100, 3), elasticity: 1f, drag: 0.01f, health: 2000, bodyDamage: 0, maxAliveNum: 1);
