...
public abstract class PixelSystem<T>(string name, int threads = 1) : PixelSystem(name, threads) where T : struct
{
...
public abstract class PixelSystem<T, T2>(string name, int threads = 1) : PixelSystem(name, threads) where T : struct where T2 : struct
{
...
public abstract class PixelSystem<T, T2, T3>(string name, int threads = 1) : PixelSystem(name, threads) where T : struct where T2 : struct where T3 : struct
{
...
public abstract class PixelSystem<T, T2, T3, T4>(string name, int threads = 1) : PixelSystem(name, threads) where T : struct where T2 : struct where T3 : struct where T4 : struct
{
...
public abstract class PixelSystem<T, T2, T3, T4, T5>(string name, int threads = 1) : PixelSystem(name, threads) where T : struct where T2 : struct where T3 : struct where T4 : struct where T5 : struct
{
